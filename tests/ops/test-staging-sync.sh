...
assert_file_contains "$TEST_REPO/.local/staging/codex/agents/explorer.toml" "description ="
assert_file_contains "$TEST_REPO/.local/staging/codex/agents/reviewer.toml" "description ="
assert_file_contains "$TEST_REPO/.local/staging/codex/skills/research-first/SKILL.md" "name: research-first"
assert_file_contains "$TEST_REPO/.local/staging/codex/skills/tdd-workflow/SKILL.md" "name: tdd-workflow"
assert_file_contains "$TEST_REPO/.local/staging/codex/skills/verification-loop/SKILL.md" "name: verification-loop"

...
The baseline contract is to interpret the prompt, shape provisional acceptance criteria, and hand off the shared `constraint packet` before downstream implementation takes over.
